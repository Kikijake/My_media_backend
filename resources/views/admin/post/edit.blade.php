...
<div class="col-4">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{route('admin#post#update',['id'=>$editData->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <div>
                        <label for="">Title</label>
                        <input type="text" name="postTitle" class=" form-control" placeholder="Enter Category Name" value="{{old('postTitle',$editData->title)}}">
                        @error('postTitle')
                    ...
                    <div>
                        ...
                        placeholder="Enter Description">{{old('postDescription',$editData->description)}}</textarea>
                    ...
                    <div class="">
                        ...
                        <div id="image-container">
                            <img
                            @if ($editData->image)
                            src="{{asset('postImage/'.$editData->image)}}"
                            class="w-50 object-cover img-thumbnail"
                            id="uploaded-image" alt="Uploaded Image">
                            @else
                            <img src="{{asset('postImage/AddImage.png')}}"  id="uploaded-image" alt="Uploaded Image" class="w-50 object-cover img-thumbnail">
                            @endif
                          </div>
                    ...
                    <div>
                        ...
                        <select name="postCategory" id="" class="form-control">
                            ...
                            @foreach ($category as $c )
                                @if ($c->id == old('postCategory',$editData->category_id))
                    ...
                    <div class=" d-flex justify-content-between">
                        <a href="{{route('admin#post')}}" type="submit" class="btn btn-secondary mt-2">Back to Create Page</a>
