...
<div class="col-4">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{route('admin#category#update',['id'=>$updateData->id])}}" method="POST">
                @csrf
                <div class=" form-group">
                    ...
                    <div>
                        ...
                        <textarea name="categoryDescription" class=" form-control" cols="30" rows="10"
                    ...
                    <div class=" d-flex justify-content-between">
                        <a href="{{route('admin#category')}}" type="submit" class="btn btn-secondary mt-2">Back to Create Page</a>
